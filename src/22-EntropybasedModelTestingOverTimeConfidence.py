...
f = open("../Model/Entropy/Model_Week_0","rb")
clf = pickle.load(f)
...
for i in range(len(x_test)):
    ...
    #     f = open("../Model/Entropy/Model_Week_"+str(i),"rb")
    #     clf = pickle.load(f)


    if (1.0*average/len(preds)) < 0.8:
...
# f = open("../Pickles/RetrainingMatrices/EntropyConfMinimum","wb")
...
f = open("../Pickles/RetrainingMatrices/EntropyConfAVG","wb")
