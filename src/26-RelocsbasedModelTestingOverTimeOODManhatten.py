...
lof = LocalOutlierFactor(novelty=True,n_neighbors=5,leaf_size=5,n_jobs=-1, metric = "manhattan")
lof.fit(x_train)
...
for i in range(len(x_test)):
    ...
    x_train = np.concatenate((x_train,x_test_n))
...
f = open("../Pickles/RetrainingMatrices/RelocsOODManhattan","wb")
