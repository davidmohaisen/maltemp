...
def load_data_time_at_once(pathMalware, pathBenign, MalwareList, BenignList, year, endYear):
    ...
    return x_train,y_train,x_test,y_test,x_test_old,y_test_old
...
save_dir = os.path.join(os.getcwd(), '../Model/Image/Random/')
...
with open("../Model/Image/Random/Baseline.json", "w") as json_file:
