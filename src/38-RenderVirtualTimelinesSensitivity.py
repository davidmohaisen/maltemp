...
for sens in np.arange(0.0000000001,0.5,0.005):
    ...
    for i in range(len(steps)-1):
        ...
        lof = LocalOutlierFactor(metric="cosine",novelty=True,n_neighbors=8,leaf_size=10000,n_jobs=-1,contamination=sens)
...
f = open("../Pickles/VirtualTimeline/VirtualSimulationSensitivity","wb")
