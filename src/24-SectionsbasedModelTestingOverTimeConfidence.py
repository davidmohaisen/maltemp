...
f = open("../Model/Sections/Model_Week_0","rb")
clf = pickle.load(f)
...
# f = open("../Pickles/RetrainingMatrices/SectionsConfMinimum","wb")
...
f = open("../Pickles/RetrainingMatrices/SectionsConfAVG","wb")
