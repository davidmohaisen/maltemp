...
print("Finished Vectorization: 7")
x_test_out_family = vectorize(x_test_out_family,dic)
print("Finished Vectorization: 8")
x_test_sing = vectorize(x_test_sing,dic)

print("Finished Vectorization: 9")
