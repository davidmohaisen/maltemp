...
ax.plot(np.arange(0,1000), l_step_error, '-r', label="SDR",lw=0.2);
ax.plot(np.arange(0,1000), l_false_acceptance, '-k', label="FAR",lw=0.2);
ax.plot(np.arange(0,1000), l_average_detection, '-b', label="ADR",lw=0.2);
ax.xaxis.set_major_locator(MultipleLocator(200))
ax.xaxis.set_minor_locator(MultipleLocator(20))
ax.yaxis.set_major_locator(MultipleLocator(0.20))
ax.yaxis.set_minor_locator(MultipleLocator(0.020))
plt.ylim(0.00, 1.0)
plt.xlim(0.0, 1000)
